...
int main(void)
{
  ...
  Lcd_cursor(&lcd, 0, 0);
  Lcd_string(&lcd, "MERIL GOLDLINA A");

  Lcd_cursor(&lcd, 1, 0);
  Lcd_string(&lcd, "212224040189");
...
## Output screen shots of proteus  :
 ...
 <img width="1920" height="1200" alt="Screenshot 2026-05-16 095032" src="https://github.com/user-attachments/assets/9fffcb08-1fe9-4c78-8a4b-2d3fcd36567a" />

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 

<img width="1212" height="850" alt="image" src="https://github.com/user-attachments/assets/556ff541-bd31-4f87-810b-399c952881b9" />
